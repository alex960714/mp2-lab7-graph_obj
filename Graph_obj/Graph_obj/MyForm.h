...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->íàğèñîâàòüToolStripMenuItem1->Size = System::Drawing::Size(139, 22);
			...
			this->òåñòToolStripMenuItem->Size = System::Drawing::Size(139, 22);
			...
			this->button7->Text = L"Ãğóïïà îáúåêòîâ";
			this->button7->UseVisualStyleBackColor = true;
			this->button7->Click += gcnew System::EventHandler(this, &MyForm::íàğèñîâàòüToolStripMenuItem_Click);
			// 
			// label1
			// 
			...
			this->button8->Text = L"Äâèæåíèå ãğóïïû";
			this->button8->UseVisualStyleBackColor = true;
			this->button8->Click += gcnew System::EventHandler(this, &MyForm::äâèæåíèåToolStripMenuItem_Click);
			// 
			// MyForm
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Îòğèñîâêà ãåîìåòğè÷åñêèõ îáúåêòîâ";
...
private: System::Void îêğóæíîñòüToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (IsGroup)
		label1->Text = "Ãğóïïà - Îêğóæíîñòü";
	else
		label1->Text = "Îêğóæíîñòü";
}
...
private: System::Void ïğÿìîóãîëüíèêToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (IsGroup)
		label1->Text = "Ãğóïïà - Ïğÿìîóãîëüíèê";
	else
		label1->Text = "Ïğÿìîóãîëüíèê";
}
